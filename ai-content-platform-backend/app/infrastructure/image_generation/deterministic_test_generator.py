"""Deterministic image generator used only by in-memory unit-test pipelines."""
...
class DeterministicTestImageGenerator:
    """Produce stable PNG pixels without registering an application provider."""
    ...
    async def generate(self, request: ImageGenerationRequest) -> ImageGenerationResult:
        ...
        draw.rectangle(
            [60, height - 200, width - 60, height - 60],
            outline="#1A5CB0",
            width=2,
        )
        ...
        return ImageGenerationResult(
            ...
            model="deterministic-gradient-v1",
            latency_ms=latency,
            cost_estimate=0.0,
